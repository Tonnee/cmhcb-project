...
export const ADMIN_DOCS_ITEMS: AdminDocItem[] = [
  ...
  },
  {
    ...
    title: "Homepage 'About' Teaser with Inline Image Badges",
    category: "static",
    isEditable: false,
    livePage: { name: "Homepage (About Teaser)", url: "/#about" },
    summary:
      "The animated sentence on the homepage: 'We connect licensed therapists [portrait], mental health programs [brain icon], and personalized care [heart icon]'.",
    fields: [
      "Headline sentence with circular inline image badges",
      "Therapist portrait badge (/home-about-image/licensed-mental-health-therapist.png)",
      "Brain icon badge (/home-about-image/mental-health-brain-icon.png)",
    ],
    steps: [
      "Note: Admin > Pages > About Us updates the dedicated `/about` page, NOT this homepage teaser sentence.",
      "This homepage teaser is hardcoded into `features/home/components/about.tsx`.",
      "Modifications must be performed by the developer in the component code.",
    ],
    codeLocation: "features/home/components/about.tsx",
    staticNotice:
      "STATIC SYSTEM CONTENT: Hardcoded in `features/home/components/about.tsx`. The Admin 'About Us' tab only configures the `/about` route, not this homepage badge element.",
