    ...
    <section className="bg-accent py-24 mb-10">
      <div className="container">
        <div className="flex flex-col items-center gap-12">
          {/* Heading */}
          <h2 className="font-marcellus text-4xl md:text-5xl leading-tight text-center text-black">
            Take The Next Step - Schedule Your{" "}
            <span className="text-white">Appointment</span>
          </h2>

          {/* Subtitle */}
          <p className="font-sans text-lg leading-relaxed text-center text-black mx-auto">
