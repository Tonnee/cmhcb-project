...
export default function AdminSidebar({
  ...
  return (
    <>
      ...
      {/* Sidebar Container */}
      <aside
        className={`fixed inset-y-0 left-0 z-50 bg-white border-r border-muted h-screen flex flex-col justify-between shrink-0 overflow-y-auto w-64 md:w-72 transition-transform duration-300 ease-in-out lg:translate-x-0 lg:static lg:z-auto ${
        ...
        <div className="flex flex-col gap-8 p-6">
          ...
          <div className="flex items-center justify-between pb-6 border-b border-muted">
            ...
            <button
              type="button"
              onClick={onClose}
              className="lg:hidden p-2 text-light-ash hover:bg-light/30 hover:text-dark rounded-xl transition-all cursor-pointer border border-muted/60"
