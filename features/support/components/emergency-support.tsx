          ...
          {contactsList.map((contact) => {
            ...
            if (contact.isPrimary) {
              return (
                <div
                  key={contact.title}
                  className="bg-primary-dark text-white rounded-4xl p-8 md:p-10 flex flex-col justify-between w-full h-full border border-primary-dark shadow-primary-glow hover:shadow-primary-glow-hover transition-all duration-300"
                >
                  <div>
            ...
            return (
              <div
                key={contact.title}
                className="bg-white rounded-4xl p-8 md:p-10 border border-muted/30 hover:border-primary-dark/30 transition-all duration-300 hover:shadow-light-glow-hover flex flex-col justify-between w-full h-full"
              >
                <div>
