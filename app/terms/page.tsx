...
<div>
  <h2 class="font-marcellus text-2xl text-primary-dark mb-4 mt-8">1. Medical Disclaimer</h2>
  <p class="mb-4">
...
<div>
  <h2 class="font-marcellus text-2xl text-primary-dark mb-4 mt-8">2. Use of Services</h2>
  <p class="mb-4">When booking and attending therapy sessions with CMHCB, you agree that:</p>
...
<div>
  <h2 class="font-marcellus text-2xl text-primary-dark mb-4 mt-8">3. Appointments and Cancellations</h2>
  <p class="mb-4">
...
<div>
  <h2 class="font-marcellus text-2xl text-primary-dark mb-4 mt-8">4. Payments and Billing</h2>
  <p>
...
<div>
  <h2 class="font-marcellus text-2xl text-primary-dark mb-4 mt-8">5. Intellectual Property</h2>
  <p>
...
<div>
  <h2 class="font-marcellus text-2xl text-primary-dark mb-4 mt-8">6. Limitation of Liability</h2>
  <p>
...
<div>
  <h2 class="font-marcellus text-2xl text-primary-dark mb-4 mt-8">7. Changes to Terms</h2>
  <p>
