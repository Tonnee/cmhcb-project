...
export async function generateMetadata({
  ...
  try {
    ...
    const url = `https://cmhcbd.com/events-workshops/${event.slug}`;
...
export default async function EventRegistrationPage({
  ...
  const eventJsonLd = {
    ...
    "@type": "Event",
    "@id": `https://cmhcbd.com/events-workshops/${event.slug}#event`,
    name: event.title,
    description: event.description,
    ...
    location: event.location.toLowerCase().includes("online")
      ? {
          ...
          url: `https://cmhcbd.com/events-workshops/${event.slug}`,
        }
      : {
          "@type": "Place",
          name: event.location,
  ...
  const breadcrumbJsonLd = {
    ...
    itemListElement: [
      ...
      },
      {
        ...
        item: "https://cmhcbd.com/events-workshops",
      },
      {
        "@type": "ListItem",
        position: 3,
        name: event.title,
        item: `https://cmhcbd.com/events-workshops/${event.slug}`,
      },
    ],
  };
      ...
      <main>
        ...
        <Container className="py-20">
          <article
            ...
            dangerouslySetInnerHTML={{ __html: formatContentToHtml(event.content || event.description) }}
          />
        </Container>
        ...
        <div className="flex flex-col lg:flex-row gap-16 lg:gap-24">
          ...
          <div className="flex-1">
            ...
            <div className="flex flex-col gap-6 ">
              ...
              <div className="flex items-start gap-6">
                ...
                <div className="pt-1">
                  <h3 className="font-bold text-dark text-lg mb-1">Instructor</h3>
                  <p className="font-sans text-base text-light-ash">
                    {event.author}
                  </p>
                </div>
          ...
          <div className="w-full lg:w-110 shrink-0">
            <div className="sticky top-28 bg-white rounded-3xl p-8 shadow-xl border border-gray-100">
              <h2 className="font-marcellus text-2xl text-dark mb-2">Register for Event</h2>
              <p className="font-sans text-sm text-light-ash mb-6">Fill out your details below to reserve your spot.</p>
