      ...
      <section className="pt-10 pb-20">
        <Container>
          <div className="max-w-4xl font-sans text-base leading-relaxed text-dark space-y-8">
            ...
            <div>
              <h2 className="font-marcellus text-2xl text-primary-dark mb-4 mt-8">1. Information We Collect</h2>
            ...
            <div>
              <h2 className="font-marcellus text-2xl text-primary-dark mb-4 mt-8">2. How We Use Your Information</h2>
              <p className="mb-4">The information we collect is strictly used for:</p>
              <ul className="list-disc pl-6 space-y-2">
            ...
            <div>
              <h2 className="font-marcellus text-2xl text-primary-dark mb-4 mt-8">3. Patient Confidentiality</h2>
              <p>
            ...
            <div>
              <h2 className="font-marcellus text-2xl text-primary-dark mb-4 mt-8">4. Data Security</h2>
              <p>
            ...
            <div>
              <h2 className="font-marcellus text-2xl text-primary-dark mb-4 mt-8">5. Your Rights</h2>
